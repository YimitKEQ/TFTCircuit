...
const championsData = [
    ...
    },
    {
        ...
        name: 'Kennen',
        cost: 1,
        traits: ['Supreme Cells', 'Protector'],
...
const itemsData = {
    ...
    completed: [
        ...
        { id: 'nashors-tooth', name: 'Nashor\'s Tooth', icon: 'assets/images/items/nashor\'s-tooth.png' },
        ...
        { id: 'steraks-gage', name: 'Sterak\'s Gage', icon: 'assets/images/items/sterak\'s-gage.png' },
    ...
    radiant: [
        ...
        { id: 'radiant-krakens-fury', name: 'Radiant Kraken\'s Fury', icon: 'assets/images/items/krakensfury.png' },
...
const comps = [
    ...
    },
    {
        ...
        avgPlace: 4.0,
        winRate: 16.5,
        champions: ["Gwen", "Sett", "Kalista", "Shen", "Aatrox", "Yone", "Braum"],
    ...
    },
    {
        ...
        avgPlace: 4.2,
        winRate: 14.0,
        champions: ["Garen", "Ezreal", "Caitlyn", "Leona", "Yone", "Sett"],
    ...
    },
    {
        ...
        avgPlace: 4.2,
        winRate: 14.5,
        champions: ["Kayle", "Aatrox", "Shen", "K'Sante", "Yone", "Gwen"],
    ...
    },
    {
        ...
        avgPlace: 4.3,
        winRate: 13.5,
        champions: ["Ashe", "Swain", "Janna", "Garen", "Shen", "Leona", "Braum"],
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function createCompCard(comp) {
        const championsHTML = comp.champions.map(championName => {
            ...
            return `<img src="assets/images/champions/${champion.id.toLowerCase()}.png" alt="${champion.name}" class="unit-icon" data-champion-id="${champion.id}">`;
        }).join('');
